...
runs(0.6, 6.66, 7.1, 0.6, [
    ...
    [("· BISTRO(LSTM 백본) = ", False, INK, 8.8), ("직접학습", True, WARM, 8.8),
...
rect(X, 5.98, W, 1.0, BGGREY, None)
rect(X, 5.98, 0.045, 1.0, GREY)
runs(X + 0.2, 6.05, W - 0.4, 0.9, [
    [("유의 ①: 본 실측 대상은 BISTRO의 LSTM 예측 백본을 당사가 GDP 과제용으로", False, GREY, 8.5)],
    [("재구현한 이식판 — 원 연구 판정이 아니며, 원본도 동일 규약 채점 시 비교 가능.", False, GREY, 8.5)],
    [("유의 ②: BISTRO의 HCX 문맥학습(ICL) 구성요소는 학습데이터 오염 문제로", False, GREY, 8.5)],
    [("실시간 채점이 성립하지 않아 본 비교 실험의 대상이 될 수 없음 (종합리포트 4장).", False, GREY, 8.5)],
], sp=1.5)
