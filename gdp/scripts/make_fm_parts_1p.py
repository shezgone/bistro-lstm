...
runs(X + 0.2, 3.8, W - 0.2, 2.55, [
    ...
    [("원인은 훈련 문제의 차이입니다:", False, INK, 9)],
    [("· Moirai: “전부를 함께 예측하라” — 공변량 = ", False, INK, 9),
     ("함께 예측되는 이웃", True, INK, 9), (",", False, INK, 9)],
    [("  이웃을 참고해 타깃을 맞히도록 채점받은 적 없음", False, INK, 9)],
    [("· Chronos-2: “저것을 참고해 이것을 맞혀라” — 공변량 = ", False, INK, 9),
     ("힌트", True, INK, 9), (",", False, INK, 9)],
    [("  힌트 활용 실패에 벌점이 집중되도록 훈련됨", False, INK, 9)],
