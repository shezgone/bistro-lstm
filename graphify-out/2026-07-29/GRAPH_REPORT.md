...
## Corpus Check
- 122 files · ~86,125 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1563 nodes · 2123 edges · 131 communities (106 shown, 25 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 61 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1cc41b1f`
...
### Community 39 - "ImportanceAnalyzer"
Cohesion: 0.23
...
Cohesion: 0.11
Nodes (28): compare_forecasts(), compare_variable_rankings(), compute_metrics(), load_bistro_ablation(), load_bistro_results(), load_lstm_ablation(), load_lstm_results(), main() (+20 more)
...
- **Why does `AttentionLSTMForecaster` connect `causal_narrative.py` to `AttentionLSTMForecaster`, `ablation_study.py`, `LSTMConfig`, `lstm_model.py`, `phase_b_transformer.py`, `TorchSeq`, `Community 84`, `train_and_evaluate.py`, `ZScoreNormalizer`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `ImportanceAnalyzer` connect `ImportanceAnalyzer` to `ablation_study.py`, `comparison.py`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `LSTMConfig` connect `LSTMConfig` to `causal_narrative.py`, `ablation_study.py`, `comparison.py`, `ImportanceAnalyzer`, `train_and_evaluate.py`, `ZScoreNormalizer`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
