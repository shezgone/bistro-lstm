...
from analysis.comparison import load_bistro_results
...
def generate_report(output_path: str = None):
    if output_path is None:
        output_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "BISTRO_LSTM_Report.pdf")
