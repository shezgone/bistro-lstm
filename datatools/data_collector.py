...
OUTPUT_TOURNAMENT_DAILY_CSV = os.path.join(
    os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", "macro_panel_tournament_daily.csv"
)
OUTPUT_TOURNAMENT_FREQ_CSV = os.path.join(
    os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", "variable_freq_tournament.csv"
)
